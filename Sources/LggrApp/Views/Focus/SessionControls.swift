...
//
// Two of them, and there will never be a third here. `Capture` (`⌘⇧I`) arrives with interruptions in
...
/// bordered, not filled, because pausing is a detour and finishing is the point.
